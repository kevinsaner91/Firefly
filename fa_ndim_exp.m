...
% -------------------------------------------------------- %
function [best]=fa_ndim_exp(instr)
...
p1=randi([1 n],1,1); 
p2=randi([1 15],1,1); % randomized crossoverindex
parent1=ns(1,:); % best solution
parent2=ns(p1,:);% random one
ns(n-1,:)=singlePointCrossing(parent2,parent1,p2);
ns(n,:)=singlePointCrossing(parent1,parent2,p2);

function mutant=singlePointCrossing(parent1, parent2, CrossOverIndex)
    mutant = [parent1(1:CrossOverIndex) parent2(CrossOverIndex+1:end)];
